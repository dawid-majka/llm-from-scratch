...
use llm_from_scratch::train::TextDataLoader;
use llm_from_scratch::training_logger::{TrainingLogger, compute_dataset_loss, train_val_split};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let mut tokenizer = Tokenizer::new(512);
